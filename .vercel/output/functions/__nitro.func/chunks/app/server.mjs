import { getCurrentInstance, version, inject, shallowRef, computed, reactive, isReadonly, useSSRContext, createApp, toRef, isRef, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, defineAsyncComponent, withCtx, createVNode, defineComponent, h, Suspense, Transition } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=500, initial-scale=1" }, { "charset": "utf-16" }, { "name": "description", "content": "My amazing site." }], "link": [], "style": [], "script": [], "noscript": [], "charset": "utf-16", "viewport": "width=500, initial-scale=1", "title": "Nuxt app" };
const appPageTransition = { "name": "layout", "mode": "out-in" };
const appLayoutTransition = false;
const appKeepalive = false;
const vueuse_head_plugin_1MW0dCYBi0 = defineNuxtPlugin((nuxtApp) => {
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-6740b063.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "info",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/info",
    children: [],
    meta: __nuxt_page_meta || {},
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/info-4ddb89e3.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import('./_nuxt/auth-0b0f7f4b.mjs')
};
const router_qbRYjSJj0b = defineNuxtPlugin(async (nuxtApp) => {
  var _a, _b;
  let __temp, __restore;
...
const layouts = {
  default: () => import('./_nuxt/default-adfb8eb3.mjs').then((m) => m.default || m),
  list: () => import('./_nuxt/list-8401b21d.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-02163182.mjs').then((r) => r.default || r));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.2.3/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, useRuntimeConfig as a, useRequestFetch as b, createError as c, useRoute as d, entry$1 as default, defineNuxtRouteMiddleware as e, useRouter as f, defineAppConfig as g, navigateTo as n, useNuxtApp as u };
